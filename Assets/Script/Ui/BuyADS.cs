...
public class BuyADS : MonoBehaviour
{
    ...
    public CustomAudioManager customAudioManager;
	...
	public void Earm_tovide()
    {
        ...
        if (AdsManagerWrapper.INSTANCE)
        {
            ...
            }, (iRewards) =>
            {
                ...
                customAudioManager.playEarnRewards();
                UImanager.uimanager.onpenshopEarm();
    ...
    public void EarnCoin(int countRewards)
    {
        //    StartCoroutine(checkInternetConnection());
        if (AdsManagerWrapper.INSTANCE)
        {
            ...
            {
                managerdata.manager.savecoin(countRewards);
                customAudioManager.playEarnRewards();
                UImanager.uimanager.onpenshopEarm();
            });
        }
    }
    public void EarnCoinLost(int countRewards)
    {
        //    StartCoroutine(checkInternetConnection());
        if (AdsManagerWrapper.INSTANCE)
        {
            ...
            }, (iRewards) =>
            {
                managerdata.manager.savecoin(countRewards);
                customAudioManager.playEarnRewards();
                StartCoroutine(UImanager.uimanager.refreshKeyAndCoinLose());
            });
        }
    }
    public void EarnKey(int countRewards)
    {
        //    StartCoroutine(checkInternetConnection());
        if (AdsManagerWrapper.INSTANCE)
        {
            ...
            {
                managerdata.manager.savekey(countRewards);
                customAudioManager.playEarnRewards();
                UImanager.uimanager.onpenshopEarm();
            });
        }
    }
    public void EarnKeyLost(int countRewards)
    {
        //    StartCoroutine(checkInternetConnection());
        if (AdsManagerWrapper.INSTANCE)
        {
