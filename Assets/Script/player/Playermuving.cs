...
public class Playermuving : MonoBehaviour
{
    ...
    public void setTranformitem()
    {
        ...
        dummyPlayer = playermodol.GetComponent<Animator>();
        Debug.Log("sono: " + playermodol.GetComponent<CharMainPlayer>());
        if (playermodol.GetComponent<CharMainPlayer>())
        {
            animationPlayer = playermodol.GetComponent<CharMainPlayer>().player.GetComponent<Animator>();
            playermodol.GetComponent<IKanimation>().animationPlayer = animationPlayer;
        }
        // var myAnim = playermodol.GetComponentsInChildren<Animator>();
        // if(myAnim.Length != 0)
        // animationPlayer = myAnim[myAnim.Length -1 ];
        // Debug.Log("test: "+" sdfsf: "+ myAnim.Length +managerdata.manager.Getnowcharacter());
    }
    ...
    public void runamin()
    {
        ...
        dummyPlayer.SetBool("jump", false);
        emty.emtyplayer.ExitJump();
    }
    public void jupamin()
    {
        animationPlayer.SetBool("jump", true);
        dummyPlayer.SetBool("jump", true);
    }
    ...
    public void intheplaysceenmain()
    {
        ...
        dummyPlayer.SetBool("play", true);
        animationPlayer.SetBool("again", false);
        dummyPlayer.SetBool("again", false);
    ...
    public void playnowthehere()
    {
        ...
        dummyPlayer.SetBool("die", false);
        animationPlayer.SetBool("flylong", false);
        dummyPlayer.SetBool("flylong", false);
        animationPlayer.SetBool("van", false);
        dummyPlayer.SetBool("van", false);
        animationPlayer.SetBool("bay", false);
        dummyPlayer.SetBool("bay", false);
        animationPlayer.applyRootMotion = false;
        dummyPlayer.applyRootMotion = false;
    ...
    public void enterthedie()
    {
        ...
        dummyPlayer.SetBool("die", true);
        animationPlayer.SetBool("jump", false);
        dummyPlayer.SetBool("jump", false);
        animationPlayer.SetBool("cut", false);
        dummyPlayer.SetBool("cut", false);
        animationPlayer.SetBool("again", false);
        dummyPlayer.SetBool("again", false);
    }
    ...
    IEnumerator delayanimationwentouchtheship()
    {
        ...
        dummyPlayer.SetBool("touchship", true);
        yield return new WaitForSeconds(0.1f);
        animationPlayer.SetBool("touchship", false);
        dummyPlayer.SetBool("touchship", false);
    ...
    public void GetGiay()
    {
        ...
        dummyPlayer.SetBool("rungiay", true);
    ...
    IEnumerator delaydestroiitem()
    {
        ...
        dummyPlayer.SetBool("bay", true);
        animationPlayer.SetBool("down", false);
        dummyPlayer.SetBool("down", false);
    ...
    public IEnumerator delaydestroiitemlong()
    {
        ...
        dummyPlayer.SetBool("flylong", true);
        animationPlayer.SetBool("down", false);
        dummyPlayer.SetBool("down", false);
        rb.mass = 0;
        rb.useGravity = false;
    ...
    public void stopanimationitem(string nameitemanimation, string nameitem)
    {
        ...
        dummyPlayer.SetBool(nameitemanimation, false);
        switch (nameitem)
        {
            case "van":
                playermodol.transform.eulerAngles = gocquay;
            ...
            case "giay":
                Manageritem.giay = false;
                animationPlayer.SetBool("rungiay", false);
                dummyPlayer.SetBool("rungiay", false);
                giayleft.SetActive(false);
    ...
    public void Jump()
    {
        ...
        if (Manageritem.baylongcoin == false && Manageritem.baycoin == false)
        {
            if (alowjupm)
            {
                ...
                dummyPlayer.SetBool("cash", false);
                animationPlayer.SetBool("die", false);
                dummyPlayer.SetBool("die", false);
                alowjupm = false;
        ...
        if (Manageritem.baylongcoin == false && Manageritem.baycoin == false)
        {
            if (Manageritem.giay)
            {
                ...
                else if (Manageritem.van)
                {
                    ...
                    dummyPlayer.SetBool("downhavevan", true);
                }
                rb.velocity = new Vector3(0, -15, 0);
                yield return new WaitForSeconds(0.5f);
                if (Manageritem.van == false)
                {
                    ...
                    dummyPlayer.SetBool("nam", false);
                    animationPlayer.SetBool("downhavevan", false);
                    dummyPlayer.SetBool("downhavevan", false);
    ...
    public void fixanimation()
    {
        ...
        dummyPlayer.SetBool("again", true);
        try
        {
            animationPlayer.SetBool("again", true);
            dummyPlayer.SetBool("again", true);
